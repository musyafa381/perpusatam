...
// Auto-create uploads directories if they don't exist
foreach ([UPLOADS_PATH, BOOK_COVER_PATH, QR_CODES_PATH, MEMBERS_QR_CODE_PATH, LOANS_QR_CODE_PATH] as $uploadDir) {
    if (!is_dir($uploadDir)) {
