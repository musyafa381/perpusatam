...
<div class="card shadow-sm border-0">
  <div class="card-body p-4">
    <h5 class="card-title fw-bold mb-4"><i class="ti ti-building text-primary me-2"></i> Form Edit Penerbit</h5>
    <form action="<?= base_url("admin/publishers/{$publisher['id']}"); ?>" method="post">
      ...
      <div class="mb-3" style="max-width: 500px;">
        ...
        <input type="text" class="form-control <?php if ($validation->hasError('name')) : ?>is-invalid<?php endif ?>" id="name" name="name" value="<?= old('name', $publisher['name']); ?>" required>
