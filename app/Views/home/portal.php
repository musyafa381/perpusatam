...
<div class="container px-3 mb-5">
  <div class="row g-4 align-items-stretch">
    ...
    <div class="col-12 col-lg-8">
      <div class="card border-0 rounded-4 p-4 h-100 shadow-sm d-flex flex-column justify-content-between batik-container-bg" style="border: 1.5px solid #e2d5c3 !important;">
        <div>
...
<div class="container px-3 mb-5">
  <div class="p-4 p-md-5 rounded-5 shadow-sm batik-container-bg" style="border: 1.5px solid #e2d5c3;">
...
<div class="container px-3 mb-5">
  <div class="p-4 p-md-5 rounded-5 shadow-sm overflow-hidden position-relative batik-container-bg" style="border: 1.5px solid #e2d5c3;">
