      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="col-12 col-md-8 col-lg-9">
          ...
          <div class="mb-3">
            ...
            <div class="d-flex flex-wrap align-items-center gap-3 fs-7" style="color: #7c6857;">
          ...
          <!-- Key Metadata Grid (Compact & Perfectly Balanced) -->
          <div class="row g-2.5 mb-4">
              ...
              <div class="p-3 rounded-3 h-100 border transition-all" style="background: linear-gradient(135deg, #fffdfa 0%, #faf4eb 100%); border-color: #e2d5c3 !important;">
                <div class="d-flex align-items-center justify-content-between mb-1.5">
                  <div class="d-flex align-items-center gap-2">
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; background: #6e4727; color: #ffffff;">
                      <i class="ti ti-tag fs-6"></i>
                    </div>
                    <span class="fw-bold" style="color: #6e4727; font-size: 0.72rem; letter-spacing: 0.4px; text-transform: uppercase;">Nomor Panggil</span>
                  </div>
                  <?php if (!empty($book['ddc'])): ?>
                    <span class="badge px-1.5 py-0.5 rounded-2" style="background: #e8decb; color: #6e4727; font-size: 0.65rem;">DDC: <?= esc($book['ddc']); ?></span>
                  <?php endif; ?>
                </div>
                <div class="fw-extrabold ps-1 text-truncate" style="color: #4a3424; font-size: 0.95rem; font-family: 'Courier New', monospace; letter-spacing: 0.5px;">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="p-3 rounded-3 h-100 border transition-all" style="background: #faf8f5; border-color: #e8decb !important;">
                <div class="d-flex align-items-center gap-2 mb-1.5">
                  <div class="rounded-2 d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; background: #f0e6d6; color: #8b5e3c;">
                    <i class="ti ti-columns fs-6"></i>
                  </div>
                  <span class="fw-bold" style="color: #8b5e3c; font-size: 0.72rem; letter-spacing: 0.4px; text-transform: uppercase;">Lokasi Rak & Lantai</span>
                </div>
                <div class="fw-bold text-truncate ps-1" style="color: #4a3424; font-size: 0.9rem;">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="p-3 rounded-3 h-100 border transition-all" style="background: #faf8f5; border-color: #e8decb !important;">
                <div class="d-flex align-items-center gap-2 mb-1.5">
                  <div class="rounded-2 d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; background: #f0e6d6; color: #8b5e3c;">
                    <i class="ti ti-barcode fs-6"></i>
                  </div>
                  <span class="fw-bold" style="color: #8b5e3c; font-size: 0.72rem; letter-spacing: 0.4px; text-transform: uppercase;">ISBN</span>
                </div>
                <div class="fw-bold text-truncate ps-1" style="color: #4a3424; font-size: 0.9rem; font-family: 'Courier New', monospace;"><?= esc($book['isbn'] ?: '-'); ?></div>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
              <div class="p-3 rounded-3 h-100 border transition-all" style="background: #faf8f5; border-color: #e8decb !important;">
                <div class="d-flex align-items-center gap-2 mb-1.5">
                  ...
                  <span class="fw-bold" style="color: #8b5e3c; font-size: 0.72rem; letter-spacing: 0.4px; text-transform: uppercase;">Tahun Terbit</span>
                </div>
                <div class="fw-bold text-truncate ps-1" style="color: #4a3424; font-size: 0.9rem;"><?= esc($book['year'] ?: '-'); ?></div>
              </div>
            </div>
          </div>
            ...
            <a href="<?= base_url('book/' . ($rel['slug'] ?: $rel['id'])); ?>" class="text-decoration-none text-dark d-block h-100">
              <div class="card h-100 border-0 rounded-4 overflow-hidden catalog-book-card position-relative transition-all" style="background: #ffffff; border: 1.5px solid #e2d5c3 !important; box-shadow: 0 4px 14px rgba(110, 71, 39, 0.05); cursor: pointer;">
                ...
                <div class="card-body p-3 d-flex flex-column">
                  <h6 class="fw-bold mb-1 text-truncate-2" title="<?= esc($rel['title']); ?>" style="color: #2d1e18 !important; font-size: 0.9rem; line-height: 1.3; min-height: 2.4em; font-weight: 700;">
                    <?= esc($rel['title']); ?>
                  </h6>
                  ...
                  <div class="d-flex flex-column gap-1 mb-2" style="font-size: 0.725rem !important;">
                    <?php if (!empty($rCallNo)): ?>
                      <div class="text-truncate" style="color: #6e4727;" title="Nomor Panggil Buku">
                        <i class="ti ti-tag me-1" style="color: #c59b27;"></i><span class="fw-semibold">Panggil:</span> <code class="fw-bold text-dark px-1 bg-light rounded" style="font-size: 0.68rem;"><?= esc($rCallNo); ?></code>
                      </div>
                    <?php endif; ?>

                    <?php if (!empty($rel['isbn'])): ?>
                      <div class="text-truncate" style="color: #6e4727;" title="ISBN Buku">
                        <i class="ti ti-barcode me-1" style="color: #c59b27;"></i><span class="fw-semibold">ISBN:</span> <span class="fw-bold text-dark" style="font-family: 'Courier New', monospace; font-size: 0.68rem;"><?= esc($rel['isbn']); ?></span>
                      </div>
                    <?php endif; ?>
                  </div>
